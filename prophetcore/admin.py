...
from prophetcore.lib.utils import nature_field_name
# Register your models here.


admin.AdminSite.site_header = '先知漏洞挖掘系统管理后台'
admin.AdminSite.site_title = '先知漏洞挖掘系统 - PROPHET'


try:
    app_models = apps.get_app_config('prophetcore').get_models()
except Exception:
    app_models = None
