...
class NewModelView(BaseRequiredMixin, PermissionRequiredMixin,
    ...
    def get_permission_required(self):
        self.permission_required = 'prophetcore.add_%s' % (self.model_name)
    ...
    def get_form_class(self):
        ...
        try:
            form_class_path = "prophetcore.forms.{}NewForm".format(name)
            self.form_class = import_string(form_class_path)
        except BaseException:
            form_class_path = "prophetcore.forms.{}Form".format(name)
            self.form_class = import_string(form_class_path)
...
class EditModelView(BaseRequiredMixin, PermissionRequiredMixin,
    ...
    def get_permission_required(self):
        self.permission_required = 'prophetcore.change_%s' % (self.model_name)
    ...
    def get_form_class(self):
        name = self.model_name.capitalize()
        try:
            form_class_path = "prophetcore.forms.{}EditForm".format(name)
            self.form_class = import_string(form_class_path)
        except BaseException:
            form_class_path = "prophetcore.forms.{}Form".format(name)
            self.form_class = import_string(form_class_path)
