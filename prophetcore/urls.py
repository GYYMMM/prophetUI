...
from prophetcore import views
from prophetcore.list import ListModelView
from prophetcore.detail import DetailModelView
from prophetcore.edit import NewModelView, EditModelView

app_name = 'prophetcore'
